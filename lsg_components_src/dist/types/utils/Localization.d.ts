...
export declare const getDecimalSeparatorByLanguage: (locale: string) => string;
export declare const getThousandsSeparatorByLanguage: (locale: string) => string;
export declare const getActiveLanguage: () => string;
export declare const setLanguage: (lang?: PossibleLanguages) => void;
export declare const setCustomTexts: (custTexts: any) => void;
export declare const setCustomFormats: (custFormats: any) => void;
export declare const UNSAFE_getDefaultTexts: (lang: "en" | "de" | "en_GB" | "en_US") => any;
export declare const UNSAFE_getDefaultFormats: (lang: "en" | "de" | "en_GB" | "en_US") => any;
export declare const getIconTitle: (name: string, noDefault?: boolean) => any;
export declare const withField: (text: string, fields: {
    [key: string]: string;
}) => string;
export { texts, formats };
