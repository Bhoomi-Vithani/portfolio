...
const isElementInViewport = (elementIds, visibility, offset = 1, getNearest = false) => {
  const result = elementIds.reduce((acc, id) => {
    ...
    if (visibility === exports.Visibility.TOP_CLIPPED) {
    ...
    } else if (visibility === exports.Visibility.BOTTOM_CLIPPED) {
  ...
  indicatorCallbacks.forEach(callbackObject => {
    ...
    if (indicatorCallbacks.includes(callbackObject)) {
      ...
      if (!elementIdsToWatch) {
        ...
        const result = isElementInViewport(elementIdsToWatch, exports.Visibility.TOP_CLIPPED, offset, true)[0];
        if (!isEqual(result, lastResult)) {
          // eslint-disable-next-line no-param-reassign
          callbackObject.lastResult = result;
          callback(result);
...
const tryRegisterHandler = () => {
  eventHandler = eventHandler || RegisterEventHandler.registerEventHandler("scroll", runCallbacks);
};
...
exports.addIndicatorCallback = addIndicatorCallback;
exports.addScrollCallback = addScrollCallback;
exports.addVisibilityCallback = addVisibilityCallback;
exports.isElementInViewport = isElementInViewport;
exports.removeIndicatorCallback = removeIndicatorCallback;
