...
function usePreferReducedMotion() {
  const [isSSR, setIsSSR] = React__default.useState(true);
...
exports.isPreferReducedMotion = isPreferReducedMotion;
exports.usePreferReducedMotion = usePreferReducedMotion;
