...
const b = {
  ...
  successBrand: "#006B27",
  // Just in case, somebody uses it. Increased Contrast by LSG, because nglb-Definition did not meet 4.5:1 criterion
  warningLight: "#E86F00",
  ...
  warningBrand: "#C25E00",
  // Just in case, somebody uses it. Increased Contrast by LSG, because nglb-Definition did not meet 3:1 criterion
  errorLight: "#C5000E",
  errorMedium: "#BC000D",
...
// Theme: Default (light)
const themeLight = ["#ffffff",
// col-neutral-0 / base color (0)
"#ECEFF2",
// col-neutral-1
"#CED8DA",
// col-neutral-2
...
const themeDarkElevated = ["#103D4B",
// col-neutral-0 / base color (0)
"#204A58",
// col-neutral-1
"#305764",
...
const BaseColors2 = {
  ...
  // Additional Colors
  darkAccent: "var(--lsg-color-dark-accent, #002530)",
  // col-midnight-petrol
  // B & W
  black: "var(--lsg-color-black, #000)",
  // col-black
...
exports.SupportedColors = SupportedColors;
