...
const styleThemesGlobal = colors => content => {
  ...
  if (colors.medium) {
    styles += styled.styled`
            .${prefix.lsgPreGlobal}theme__medium {
  ...
  if (colors.hover) {
    ...
    styles += styled.styled`
            .${prefix.lsgPreGlobal}theme__hover {
  ...
  if (colors.dark) {
    // Important: This selector must not be prefixed as it is shared for react and stencil
    styles += styled.styled`
            .${prefix.lsgPreGlobal}theme__dark {
  ...
  if (colors.elevatedDark) {
    // Important: This selector must not be prefixed as it is shared for react and stencil
    styles += styled.styled`
                .${prefix.lsgPreGlobal}theme__dark .${prefix.lsgPreGlobal}theme__hover,
                .${prefix.lsgPreGlobal}theme__dark .${prefix.lsgPreGlobal}theme__elevated {
  ...
  if (colors.light && colors.medium) {
    styles += styled.styled`
                .${prefix.lsgPreGlobal}theme__medium .${prefix.lsgPreGlobal}theme__elevated {
                    ${content(colors.light, "light")}
                }
            `;
  }
  if (colors.contrastLight) {
    // Important: This selector must not be prefixed as it is shared for react and stencil
    styles += styled.styled`
            .${prefix.lsgPreGlobal}theme__medium .${prefix.lsgPreGlobal}theme__hover,
            .${prefix.lsgPreGlobal}theme__contrast {
  ...
  if (colors.contrastDark) {
    // Important: This selector must not be prefixed as it is shared for react and stencil
    styles += styled.styled`
            .${prefix.lsgPreGlobal}theme__dark .${prefix.lsgPreGlobal}theme__elevated .${prefix.lsgPreGlobal}theme__hover,
            .${prefix.lsgPreGlobal}theme__dark .${prefix.lsgPreGlobal}theme__contrast {
  ...
  if (colors.brand) {
    // Important: This selector must not be prefixed as it is shared for react and stencil
    styles += styled.styled`
            .${prefix.lsgPreGlobal}theme__brand,
            .${prefix.lsgPreGlobal}theme__dark .${prefix.lsgPreGlobal}theme__brand {
...
const styleThemesGlobal2 = colors => {
  const transposedColors = Object.entries(colors).map(([theme, c]) => ({
    light: {
      [theme]: typeof c === "string" ? c : c.light
    },
    medium: {
      [theme]: typeof c === "string" ? c : c.medium
    },
    dark: {
      [theme]: typeof c === "string" ? c : c.dark
    },
    hover: {
      [theme]: typeof c === "string" ? c : c.hover
    },
    elevatedDark: {
      [theme]: typeof c === "string" ? c : c.elevatedDark
    },
    contrastLight: {
      [theme]: typeof c === "string" ? c : c.contrastLight
    },
    contrastDark: {
      [theme]: typeof c === "string" ? c : c.contrastDark
    },
    brand: {
      [theme]: typeof c === "string" ? c : c.brand
    }
  })).reduce((acc, val) => ({
    light: {
      ...acc.light,
...
exports.styleThemes = styleThemes;
exports.styleThemes2 = styleThemes2;
exports.styleThemesGlobal = styleThemesGlobal;
exports.styleThemesGlobal2 = styleThemesGlobal2;
