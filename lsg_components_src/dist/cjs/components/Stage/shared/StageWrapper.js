...
var StagePresentation = require('./StagePresentation.js');

// @ts-strict-ignore
class StageWrapper extends React__default.Component {
  constructor(props) {
    super(props);
    this.layoutRegularRef = /*#__PURE__*/React__default.createRef();
    this.layoutBreakingRef = /*#__PURE__*/React__default.createRef();
    this.hostRef = /*#__PURE__*/React__default.createRef();
    this.innerRef = /*#__PURE__*/React__default.createRef();
    this.scrollerRef = /*#__PURE__*/React__default.createRef();
    this.eyeCatcherRef = /*#__PURE__*/React__default.createRef();
  ...
  componentDidMount() {
    ...
    ResizeEvents.addResizeCallback(this.doHandleResizeWindow);
    this.timeout = timing.setLsgTimeout(() => this.setState({
      hideEyeCatcher: false
    }), this.state.eyeCatcherDefaultAppearanceTime);
  }
  componentWillUnmount() {
    ResizeEvents.removeResizeCallback(this.doHandleResizeWindow);
  ...
  render() {
    return /*#__PURE__*/React__default.createElement(StagePresentation.StagePresentation, {
      ...this.props,
      hideEyeCatcher: this.state.hideEyeCatcher,
      viewport: this.state.viewport,
      layoutRegularRef: this.layoutRegularRef,
      layoutBreakingRef: this.layoutBreakingRef,
      hostRef: this.hostRef,
      innerRef: this.innerRef,
      scrollerRef: this.scrollerRef,
      layout: this.state.layout,
      eyeCatcherPosition: this.state.eyeCatcherPosition,
      eyeCatcherRef: this.eyeCatcherRef,
      onScrollerClick: this.props.onScrollerClick || this.scrollStageHeight
    });
  }
}

exports.StageWrapper = StageWrapper;
