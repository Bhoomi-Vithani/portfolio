...
var ProfileWidgetPresentation = require('./shared/ProfileWidgetPresentation.js');
 ...
 */
const ProfileWidget = ({
  profileIconVariant = "outline",
  ...props
}) => /*#__PURE__*/React__default__namespace.createElement(ProfileWidgetPresentation.ProfileWidgetPresentation, {
  profileIconVariant: profileIconVariant,
  ...props
});
