...
// @ts-strict-ignore
const ChartMousePresentation = ({
  width,
  height,
  children,
  toDataPoint
}) => {
  const [hoverPt, setHoverPt] = React__default.useState(undefined);
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, children && children(hoverPt), /*#__PURE__*/React__default.createElement("rect", {
    width: width,
    height: height,
    pointerEvents: "all",
    fill: "none",
...
exports.ChartMousePresentation = ChartMousePresentation;
