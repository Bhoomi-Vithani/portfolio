...
var PictureBackgroundPresentation = require('./PictureBackgroundPresentation.js');
...
class PictureBackgroundWrapper extends React__default.Component {
  ...
  componentDidUpdate(prevProps) {
    if (this.props.imgSrc !== prevProps.imgSrc || this.props.source !== undefined && (this.props.source?.length !== this.mediaQueryLists?.length || this.props.source?.some((s, i) => prevProps.source?.[i]?.media !== s.media))) {
      this.removeListeners();
      this.addListeners();
  ...
  render() {
    ...
    return /*#__PURE__*/React__default.createElement(PictureBackgroundPresentation.PictureBackgroundPresentation, {
      ...this.props,
...
exports.PictureBackgroundWrapper = PictureBackgroundWrapper;
