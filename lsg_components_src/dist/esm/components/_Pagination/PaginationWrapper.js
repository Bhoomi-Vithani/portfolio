...
class PaginationWrapper extends React__default.Component {
    constructor() {
        ...
        this.handleKey = (e) => {
            ...
            const focusActions = {
                ...
                [Key.Space]: () => this.selectAndUpdateFocus(iterator),
    ...
    render() {
        return (React__default.createElement(PaginationPresentation, { ...this.props, handleKey: this.handleKey, rightArrowRef: rightArrow => (this.rightArrow = rightArrow), leftArrowRef: leftArrow => (this.leftArrow = leftArrow), pageLinksRefs: (i, link) => {
