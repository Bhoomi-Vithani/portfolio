...
import { CircleCountdownWrapper } from './shared/CircleCountdownWrapper.js';

// @ts-strict-ignore
const CircleDiagram = ({ noAnimation = false, animationOnStart = false, valueLabel, chartInfoArea, ariaDescription, ariaLabel, ...props }) => {
    ...
    const chartInfoAreaInternal = chartInfoArea
        ? { ...chartInfoArea, appearance: "infoarea" }
        : undefined;
    return (
    ...
    React__default.createElement(CircleCountdownWrapper, { chartInfo: chartInfoAreaInternal, valueLabel: valueLabel || "", ariaLabel: ariaLabel || ariaDescription, noAnimation, animationOnStart, ...props }));
};
