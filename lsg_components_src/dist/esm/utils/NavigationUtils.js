...
function deepFlatten(navigationObject) {
    return navigationObject
        ? navigationObject.reduce((result, current) => [...result, current, ...deepFlatten(current.children)].filter(item => item !== undefined), [])
        : [];
}
...
export { deepFlatten, deepGenerateNavObject, getNamedNavigationTree, hasItemChildren };
