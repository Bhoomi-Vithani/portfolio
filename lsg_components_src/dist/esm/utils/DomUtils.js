// @ts-strict-ignore
const isTargetInsideContainer = (target, container) => target &&
    container &&
    (target.parentElement === container ||
        isTargetInsideContainer(target.parentElement, container));
...
export { cleanupClassNames, cleanupClassObject, formatSvgBase64Src, isSafari, isTargetInsideContainer, uniqueId };
